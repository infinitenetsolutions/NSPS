...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="add_branch_name" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Branch Address</label>
                                <input type="text" name="add_branch_address" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Branch Phone No</label>
                                <input type="text" name="add_branch_phone" class="form-control">
                            </div>
    ...
    <!-- Add Branches Modal End -->
    <!-- Add Branches With Excel Modal Start-->
    <div id="add_branches_with_excel" class="w3-modal" style="z-index:2020;">
        <div class="w3-modal-content w3-animate-top w3-card-4" style="width:40%">
            <header class="w3-container" style="background:#343a40; color:white;">
                <span onclick="document.getElementById('add_branches_with_excel').style.display='none'" class="w3-button w3-display-topright">&times;</span>
            ...
            <form  role="form" method="POST">
                <div class="card-body">
                    ...
                    <button type="reset" onclick="document.getElementById('add_branches_with_excel').style.display='none'" class="btn btn-danger">Cancel</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        $(function() {
            ...
            $('#add_branch_button').click(function() {
                ...
                $('#add_branch_button').prop('disabled', true);
                $.ajax({
                    url: 'include/controller.php',
                    type: 'POST',
                    data: $('#add_branch_form').serializeArray(),
                    success: function(result) {
                        ...
                        $('#add_branch_button').prop('disabled', false);
                    }
