...
<head>
    ...
    <title>NETAJI SUBHAS PUBLIC SCHOOL | Print Receipt</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Pay Receipt</h3>
                                ...
                                <div class="row">
                                   <div class="col-12" id="error_section"></div>
                                    ...
                                    <div class="col-2" style="margin-top: 29px;">
                                        <button type="submit" id="fetchStudentDataButton" class="btn btn-primary btn-block">Go</button>
                                    </div>
                                </div>
                            </div>
                        </form>
