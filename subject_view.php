...
<head>
    ...
    <title>NETAJI SUBHAS Public School | Section </title>
    <!-- Fav Icon -->
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="float-sm-right">
                                    <button type="button" class="btn btn-success" onclick="document.getElementById('add_subjects').style.display='block'">Add Section</button>
                                </div>
                            </div>
                            <!-- /.card-header -->
                    ...
                    <div class="row">
                      ...
                      <!--   <div class="form-group col-md-12">
                        ...
                        <table class="table table-bordered table-responsive" id="dynamic_field" style="overflow-y:auto;">
                                    <thead>
                                        <tr>
                                            <th data-field="Semester" data-sortable="true" rowspan="2">Section</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="200%"><input type="text" name="add_subject_name[]" placeholder="Section" class="form-control" /></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                i++;
                $('#dynamic_field').append('<tr id="row' + i + '" class="dynamic-added" ><td><input type="text" name="add_subject_name[]" placeholder="Section" class="form-control" /></td><td><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: 'include/view.php?action=get_section',
                type: 'GET',
                success: function(result) {
                    $("#data_table").html(result);
                }
