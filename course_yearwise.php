...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Course & Year Wise Fee Report </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Course & Year Wise Fee Report </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Course & Year Wise Fee Report </li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Course & Year Wise Fee Report </h3>
                                ...
                                <div class="row">
                                   <div class="col-12" id="error_section"></div>
                                    ...
                                    <div class="col-1" style="margin-top: 29px;">
                                        <button type="submit" id="fetchFeeDataButton" class="btn btn-primary">Go</button>
                                    </div>
                                </div>
                            </div>
                        </form>
