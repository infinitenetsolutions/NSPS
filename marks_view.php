...
<head>
    ...
    <title>NETAJI SUBHAS PUBLIC SCHOOL | Marks List </title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Marks List</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                     ...
                                     <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="subject_id">
                                                ...
                                                <?php 
                                                $sql_sub = "SELECT * FROM `tbl_subjects`
                                                WHERE `status` = '$visible';
                                                ";
    ...
    <script>
        $(document).ready(function() {
            $('#fetchStudentDataForm').submit(function( event ) {
                ...
                $.ajax({
                    url: 'include/view.php?action=fetch_student_marks',
                    type: 'POST',
