...
<head>
    ...
    <title>NETAJI SUBHAS PUBLIC SCHOOL | Fee List</title>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-success" ><a href="add_fee" style="color: #fff;">Add Fee</a></button>
                            ...
                            <div class="card-body" style="margin-top: 0px;">
                                <div class="row">
                                   <div class="col-12" id="error_section"></div>
                                    ...
                                    <div class="form-group">
                                    <label>Section</label>
                                    <select class="form-control" name="section_id" id="sem" onchange="show(this.value)">
    ...
    <script>
        $(document).ready(function() {
            $('#fetchStudentDataForm').submit(function( event ) {
                ...
                $.ajax({
                    url: 'include/view.php?action=get_fee',
                    type: 'POST',
