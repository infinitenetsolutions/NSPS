...
<?php  
    ...
    $sql = "SELECT * FROM `tbl_fee_paid`
            ...
            INNER JOIN `tbl_class` ON `tbl_fee_paid`.`course_id` = `tbl_class`.`course_id`
    ...
    // WHERE `status` = '$visible' AND `course_id` = '".$row["course_id"]."' AND `fee_academic_year` = '".$row["admission_session"]."' AND `fee_particulars` NOT IN ('HOSTEL FEE', 'hostel fee', 'Hostel Fee', 'HOSTELS FEES', 'hostels fees', 'Hostels Fees', 'HOSTELS FEE', 'hostels fee', 'Hostels Fee', 'HOSTEL FEES', 'hostel fees', 'Hostel Fees', '1st Year Hostel Fee', '1ST YEAR HOSTEL FEE', '2nd Year Hostel Fee', '2ND YEAR HOSTEL FEE', '3rd Year Hostel Fee', '3RD YEAR HOSTEL FEE', '4th Year Hostel Fee', '4TH YEAR HOSTEL FEE', '5th Year Hostel Fee', '5TH YEAR HOSTEL FEE', '6th Year Hostel Fee', '6TH YEAR HOSTEL FEE') ORDER BY `fee_particulars` ASC
    // "; 
    $sqlTblFee = "SELECT * FROM `tbl_fee_paid`
                WHERE `course_id` = '".$row["course_id"]."' ORDER BY `particular_id` ASC";
            
            // echo $sqlTblFee;
            // exit();    
            // $_name = $row_fe['branch_name'];
    
    $resultTblFee = $con->query($sqlTblFee);
    if($resultTblFee->num_rows > 0)
        while($rowTblFee = $resultTblFee->fetch_assoc()){

            // fetching fee particular details
            $pr_id= $rowTblFee['particular_id'];
            $sc_id= $rowTblFee['section_id'];
            $br_id= $rowTblFee['branch_id'];
            //  echo $pr_id;
            // exit();    
            // $sql_fe = "SELECT * FROM `tbl_fee` WHERE `id` = $pr_id ";
            
        }
        $sql_fe = "SELECT * FROM `tbl_fee` WHERE `section` = $sc_id AND `branch` = $br_id";
            $result_fe = $con->query($sql_fe);
            $row_fe = $result_fe->fetch_assoc();

            $totalFee = $totalFee + intval($row_fe["fee"]);
            if(strtotime(date($row_fe["last_date"])) < strtotime(date("Y-m-d")))
                $noOfDays = (strtotime(date("Y-m-d")) - strtotime(date($row_fe["last_date"])))/60/60/24;
            else
                $noOfDays = 0;
            $completeArray = array(
                                "fee_id" => $row_fe["id"],
                                "fee_particulars" => $row_fe["particular"],
                                "fee_amount" => $row_fe["fee"],
                                "fee_paid" => 0,
                                "fee_fine" => $row_fe["fine_amount"],
                                "fee_rebate" => 0,
                                "fee_remaining" => $row_fe["fee"],
...
<head>
    ...
    <title> NETAJI SUBHAS PUBLIC SCHOOL : Fee Payment</title>
	<!--<style media="print">-->
	<!-- @page {-->
	<!--  size: auto;-->
	<!--  margin: 0;-->
...
<body class="body_pop">
    ...
    <div id="divToPrint" >
    <table width="645" align="center" class="tb2_grid" style=" border: 2px solid #333333 ;border-color: #333333  !important;" >
	<!--<p style="position: fixed;right: 3%;">
	<a href="" id="printbutton" value="&nbsp;Print" onclick="return printing();"><img src="images/print.jpg" style="height: 80px;" ></a>
	</p>-->
        <tr>
                ...
                <table width="100%" border="0" style="margin-top:12px;">
                    <tr>
                        <td align="right" valign="top" colspan="3">
                            <table width="100%" border="0" style="border-color: #333333  !important;">
                                <!--<tr>
                                    <td colspan="2" align="center" valign="top">&nbsp;</td>
                                </tr>-->
                                <tr>
                                    <td width="8%" rowspan="4" align="center" valign="top"><img src="images/logo.png" style="width: 158px;" alt="Image" border="0" title="Images">&nbsp;</td>
                                    <td width="92%" align="center" valign="top"><span class="style1" style="font-size:30px;">NETAJI SUBHAS UNIVERSITY</span></td>
                                </tr>
                                <?php 
                                    $stu = $row["student_id"];
                                    $sql_stu = "SELECT * FROM `tbl_student` WHERE `student_id` =  $stu";
                                        // echo $sql_stu;
                                        // exit();            
                                    $result_stu = $con->query($sql_stu);
                                    $row_stu = $result_stu->fetch_assoc();
                                    $brc = $row_stu['branch_id'];
                                    
                                   
                                    $sql_brc = "SELECT * FROM `tbl_branch` WHERE `id` =  $brc";
                                    $result_brc = $con->query($sql_brc);
                                    $row_brc = $result_brc->fetch_assoc();
                                    $brc_name = $row_brc['branch_name'];
                                    $brc_address = $row_brc['branch_address'];
                                    // echo $brc1;exit();
                                ?>
                                <tr style="font-size: 13px;">
                                    <td align="center" valign="top" style="padding-bottom: 25px;"><strong><?php echo $brc_address; ?></td>
                                </tr>
                    ...
                    <tr>
                        <td height="93" colspan="3">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: -25px;" style="border-color: #333333  !important;">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    ...
                                                    <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center" style="border-color: #333333 !important;">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" class="narmal">:</td>
                                                            <td align="left" class="narmal"><?php echo $row_stu['reg_no']; ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" class="narmal" width="27%"><?php echo strtoupper($row_stu['student_name']); ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" class="narmal">:</td>
                                                            <td align="left" class="narmal"><?php echo strtoupper($row_stu["father_name"]); ?></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tbl_grid" style="border-color: #333333 !important;"><br>
                                                        <tr>
                                                            <td align="left" class="adminfont" colspan="7">&nbsp;<b>Fee Details for Class : <?php echo $row["course_name"]; ?></b> </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tbl_grid" style="border-color: #333333 !important;"><br>
                                                        <tr>
                                                            <td align="left" class="adminfont" colspan="7" style="border-color: #333333 !important;">&nbsp;<b>Total Fee Paid</b></td>
                                                        </tr>
                                       ...
                                       <?php 
                                        ...
                                        <tr height="25" style="color:black!important;">
                                           <!-- <td width="30%" align="center" valign="middle" class="admin"><?php// echo $rebateOn; ?></td>-->
                                            <td width="30%" align="center" valign="middle" class="admin blk">Rs. <?php echo $totalPaid + $fineAmount; ?>.00</td>
                                            <td width="30%" align="center" valign="middle" class="admin blk">Rs. <?php echo $totalRebate; ?>.00</td>
                                            <td width="30%" align="center" valign="middle" class="admin blk">Rs. <?php echo $fineAmount ?>.00</td>
                                            <td width="30%" align="center" valign="middle" class="admin blk">Rs. <?php echo $row["balance"]; ?>.00</td>
                                        </tr>
                                                        ...
                                                        <tr height="25">
                                                            <td align="right" colspan="6" style="padding-right:25px;" class="admin blk">Authorised Signatory</td>
                                                        </tr>
                                                        <tr height="25">
                                                            <td align="left" colspan="6" style="padding-right:25px;" class="admin blk">Note:- Fee once paid will not be refunded and Please keep this slip for your reference</td>
                                                        </tr>
...
<body class="body_pop">
    <table width="645" align="center" class="tb2_grid" style="border-color: #333333 !important; border: 2px solid #333333;">
        	<p style="position: fixed;right: 3%;">
	<a href="" id="printbutton" value="&nbsp;Print" onclick="return printing();"><img src="images/print.jpg" style="height: 80px;" ></a>
	</p>
        <tr>
            <td width="635">
                <table width="100%" border="0" style="border-color: #333333 !important;margin-top:12px;">
                    <tr>
                        <td align="right" valign="top" colspan="3">
                            <table width="100%" border="0" style="border-color: #333333 !important;">
                                <tr>
                                    ...
                                    <td width="92%" align="center" valign="top"><span class="style1" style="font-size:30px;">NETAJI SUBHAS PUBLIC SCHOOL</span></td>
                                </tr>
                                <tr style="font-size: 13px;">
	...
	function newWindowOpen(href){
		...
		window.open(href,null, 'width=900,height=900,scrollbars=yes,toolbar=no,directories=no,status=no,menubar=yes,left=140,top=30');
               ...
               <!--                             </tr>-->
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tbl_grid" style="border-color: #333333 !important;">
                                                        <tr height="50">
