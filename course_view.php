...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Classes </title>
    <!-- Fav Icon -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="float-sm-right">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="document.getElementById('add_courses').style.display='block'">Add Class</button>
                                </div>
                            </div>
                            <!-- /.card-header -->
